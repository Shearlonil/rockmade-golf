            ...
            >
                <Container>
                    <h2 className="text-center mb-4 display-5 fw-bold">
                        <span className="word-span">RockMade</span> <span className="text-danger">Golf</span>
                    </h2>
                    ...
                    <div className="d-flex flex-column align-items-center justify-content-center mt-5">
                        ...
                        <div className="fs-5 col-lg-8">
                            <p className="fw-bold">
                                <GiCheckMark color="var(--secondary-color)" /> Track the climb
                            </p>
                            <p>
                                Our website is built to track the progress of higher handicappers — turning data into development. We give players a structured path to lower scores, better skills, and lasting confidence.
                            </p>
                            <p className="fw-bold">
                                <GiCheckMark color="var(--secondary-color)" /> Fund the next generation
                            </p>
                            <p>
                                RockMade Golf is also a platform to generate funds for younger golfers. Proceeds go directly into training, coaching, and creating opportunities for them to compete locally and internationally.
                            </p>
                            <p>
                    ...
                    <Row>
                        <Col md={6} className="text-center">
                            <div className="h-100 d-flex flex-column justify-content-center align-items-center p-4">
                                <h3 className="display-6 fw-bold" style={{ color: "var(--primary-color)" }}  >
                                    Our Mission
                                </h3>
                                <p>
                            ...
                            <div className="about-text-wrap">
                                ...
                                <div className="about-text-info d-flex">
                                    ...
                                    <div className="ms-4">
                                        ...
                                        <p className="mb-0">
                                            Join games, challenge friends, and enjoy golf like never before.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        {[
                            ...
                            <Col key={idx} md={2} sm={6} className="mb-3">
                                <Card className="p-3 shadow-sm rounded-3 d-flex flex-column align-items-center h-100">
                                    <img src={icon} width="55px" height="55px" alt={name} className="mb-3" />
                ...
                <Container>
                    <div className="text-center mb-4">
                        <h2 className="display-5 fw-bold">
                            <span className="text-primary">Meet</span> the <span className="text-danger">Team</span>
                            </h2>
                        <p className="lead">
                    ...
                    <Row>
                        <Col md={4} className="mb-4">
                            <Card className="p-3 shadow border-0 rounded-3 text-center">
                                ...
                                />
                                <h5 className="fw-bold">Pro Mubasiru Sanusi</h5>
                                <p className="text-muted">Founder & C E O</p>
                                <p>
                                    At the helm of RockMade Golf is Pro Mubasiru Sanusi, CEO and visionary. He brings both academic excellence and on-course pedigree to the role, graduating with a First Class degree in BSc Human Kinetics.
                                </p>
                            </Card>
                        </Col>
                        <Col md={4} className="mb-4">
                            <Card className="p-3 shadow border-0 rounded-3 text-center">
                                ...
                                />
                                <h5 className="fw-bold">Adubi Ibrahim Olatunde</h5>
